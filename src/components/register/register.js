...
export const RegisterAsCustomer = () => {
    ...
    return (
        <div className='flex flex-col w-screen h-screen'>
            <nav className='p-2 absolute top-0 left-0 w-full flex flex-row justify-between items-center'>
            ...
            <div className='h-full flex-grow  grid sm:grid-cols-1 md:grid-cols-2 grid-rows-1 items-center content-center'>
                <main>
                    <form className='p-3 flex flex-col gap-5 max-w-sm m-4' >
                        ...
                        <button type="button" onClick={login} className="bg-orange-500 text-white rounded">Register</button>
                    </form>
                </main>
